class SolveurService:
    ...
    def getPossibilites(self, selected_cell):
        self.loadGrilleData()
        possibilites = []
        for i in range(1, self.n + 1):
            if self.checkValue(selected_cell.r, selected_cell.c, i):
    ...
    def autoComplete(self, selected_cell):
        ...
        # Ligne
        cells_lignes = [cell for cell in self.grille.cells if not cell.fixed and cell.r == selected_cell.r and cell.cell_valeur.value == 0]
        if len(cells_lignes) == 1:
            cells_to_check.append(cells_lignes[0])

        # Colonne
        cells_colonnes = [cell for cell in self.grille.cells if not cell.fixed and cell.c == selected_cell.c and cell.cell_valeur.value == 0]
        ...
        for r in range(start_row * div, (start_row * div) + div):
            for c in range(start_col * div, (start_col * div) + div):
                cell = next((cell for cell in self.grille.cells if not cell.fixed and cell.r == r and cell.c == c and cell.cell_valeur.value == 0), None)
        ...
        for cell in cells_to_check:
            possibilites = self.getPossibilites(cell)
